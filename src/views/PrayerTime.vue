        ...
        <div class="prayer__time-wrapper">
            ...
            <div class="time__content-header">
                ...
                <div class="item-content">
                    ...
                    <p>Region:</p>
                    <h4>{{ this.time_data && this.time_data.region }}</h4>
                </div>
                <div class="item-content">
                    <span class="material-symbols-outlined">date_range</span>
                    <p>Hafta kuni:</p>
                    <h4>{{ this.time_data && this.time_data.weekday}}</h4>
                </div>
                <div class="item-content">
                    <span class="material-symbols-outlined">schedule</span>
                    <p>Sana:</p>
                    <h4>{{ this.time_data && this.time_data.date}}</h4>
                </div>
            ...
            <div class="time__card-wrapper">
                <div class="prayer__time-card">
                        <p>Bomdod</p>
                        <h3>{{ this.time_data && this.time_data?.times?.tong_saharlik }}</h3>
                </div>
                <div class="prayer__time-card">
                        <p>Peshin</p>
                        <h3>{{ this.time_data && this.time_data?.times?.peshin }}</h3>
                </div>
                <div class="prayer__time-card">
                        <p>Asr</p>
                        <h3>{{ this.time_data && this.time_data.times.asr }}</h3>
                </div>
                <div class="prayer__time-card">
                        <p>Shom</p>
                        <h3>{{ this.time_data && this.time_data.times.shom_iftor }}</h3>
                </div>
                <div class="prayer__time-card">
                        <p>Xufton</p>
                        <h3>{{ this.time_data && this.time_data.times.hufton }}</h3>
                </div>
            </div>
